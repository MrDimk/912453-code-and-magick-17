...
(function () {
  var renderStatistics = function (ctx, names, times) {
    ...
    drawModalWindow(
        ctx,
        sets.modalWindow.coordX,
        sets.modalWindow.coordY,
        sets.modalWindow.width,
        sets.modalWindow.height
    );
    printText(
        ctx,
        sets.modalWindow.title,
        sets.modalWindow.coordX + 20,
        sets.modalWindow.coordY + 30,
        sets.defaultFontSize
    );
    drawHistogram(
        ctx,
        sets.modalWindow.coordX + 40,
        sets.modalWindow.coordY + sets.defaultFontSize + 70,
        names,
        times
    );
  };
